...
# aws-terraform-module-inspector
---
...
module "session-manager" {
  source          = "git::ssh://git@github.com/osodevops/aws-terraform-module-inspector.git.git"
}
```
...
File a GitHub [issue](https://github.com/osodevops/aws-terraform-module-inspector/issues), send us an [email][email] or tweet us [twitter][twitter].

## Contributing

### Bug Reports & Feature Requests

Please use the [issue tracker](https://github.com/osodevops/aws-terraform-module-inspector/issues) to report any bugs or file feature requests.
